...
Then you need to get a model in gguf format from someplace like huggingface. Also place it into the models directory, or wherever you would like, you will need to imput model path in the .env file later.   This has been tested extensively with ERNIE 4.5 21B, but should work with any model. You can download ERNIE [HERE](https://huggingface.co/unsloth/ERNIE-4.5-21B-A3B-PT-GGUF/tree/main)  testing was performed with ERNIE-4.5-21B-A3B-PT-Q2_K_L.gguf
...
Once the app is loaded, you can load a model.
